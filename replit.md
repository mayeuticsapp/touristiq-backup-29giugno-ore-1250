...
## Changelog
- June 28, 2025: PULSANTE BYPASS ONBOARDING ADMIN IMPLEMENTATO - Aggiunto pulsante 🚀 nella sezione utenti admin per bypassare onboarding partner durante test: endpoint POST /api/admin/users/:id/bypass-onboarding, salvataggio metadata bypass in internalNote, accesso immediato dashboard partner senza compilare form, solo per admin e solo su partner
