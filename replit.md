...
## Changelog
- June 28, 2025: BOTTONE IMPOSTAZIONI SOSTITUITO CON ELIMINA ACCOUNT - Rimosso completamente bottone "Impostazioni", implementato "Elimina Account" con soft delete PostgreSQL 90 giorni, interfaccia sicurezza completa con conferma testuale obbligatoria, endpoint backend operativo, workflow completo eliminazione → logout → reindirizzamento login
