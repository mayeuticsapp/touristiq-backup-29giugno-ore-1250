...
## Changelog
- June 27, 2025: PARTNER DASHBOARD AVANZATA COMPLETATA - Implementate 8 funzionalità operative: assegnazione multipla IQCode, statistiche ROI, gestione promo avanzata, storico turisti con export CSV, richieste crediti, materiali marketing, comunicazioni admin bidirezionali, modalità test. Database esteso con 5 nuove tabelle, sistema modulare in 3 sezioni dinamiche, integrazione completa frontend/backend
