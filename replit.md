...
## Changelog
- June 28, 2025: FOCUS AUTOMATICO CHECK-IN → CHECK-OUT IMPLEMENTATO - Sistema completo focus automatico: selezione data check-in sposta cursore automaticamente su check-out, implementato in dashboard struttura (form ospiti), dashboard partner, mini-gestionale contabile, esperienza utente fluida e veloce per inserimento date soggiorno
