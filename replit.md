...
## Changelog
- July 1, 2025: SISTEMA VALIDAZIONE IQCODE COMPLETATO - Schema loginSchema esteso da 20 a 100 caratteri per supportare tutti i codici presenti e futuri, sistema validazione partner-turista implementato con database PostgreSQL funzionante, endpoint /api/entity-info creato per identificazione entità, funzione createTouristLinkRequest operativa per collegamento TIQ-VV-PRT-7516 → TIQ-IT-2912-BOTTICELLI, prevenzione duplicati e tracciamento completo richieste validazione, supporto universale per codici emozionali/professionali/legacy
