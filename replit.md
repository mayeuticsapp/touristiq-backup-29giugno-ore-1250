...
- June 30, 2025: APERTURA AUTOMATICA DATE PICKER COMPLETATA - Sistema completo: desktop apre automaticamente calendar check-out dopo selezione check-in con rilevamento dispositivo (!ontouchstart), mobile mantiene focus automatico, protezioni try-catch per compatibilità, esperienza UX tipo Booking.com operativa
