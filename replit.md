...
## Changelog
- July 1, 2025: RISOLTO BUG CODICI EMOZIONALI LUNGHI E SISTEMA IDENTIFICAZIONE ENTITÀ - Schema loginSchema esteso da 20 a 100 caratteri per supportare codici lunghi tipo TIQ-IT-2912-BOTTICELLI (23 caratteri), endpoint /api/entity-info creato per recuperare nome + codice IQ nell'intestazione dashboard, dashboard struttura aggiornato per mostrare "Nome Entità (CODICE)" invece del solo codice, sistema testato e funzionante con Gardenia Suite (TIQ-VV-STT-5909)
