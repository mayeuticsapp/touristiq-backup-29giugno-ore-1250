...
## Changelog
- June 28, 2025: BYPASS ONBOARDING PARTNER FUNZIONANTE - Implementato e corretto sistema bypass: pulsante 🚀 admin, endpoint backend, controllo JSON nelle note interne per riconoscere bypass, accesso immediato dashboard partner senza form obbligatorio, testato e operativo per partner TIQ-RC-PRT-5842
