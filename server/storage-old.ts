...
export class MemStorage implements IStorage {
  ...
  // Metodi messaggistica per MemStorage
  ...
  // Metodi validazione IQCode per MemStorage
  ...
  // Metodi ricariche per MemStorage
  ...
  async getRechargesWithFilters(filters: any): Promise<{recharges: any[], total: number, stats: any}> {
    return { recharges: [], total: 0, stats: {} };
  }

  // Metodi offerte per MemStorage
